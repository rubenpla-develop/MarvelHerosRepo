...
class RestApiImpl @Inject constructor(private val retrofitApi: RetrofitApi) : RestApi {
    ...
    override suspend fun getCharacters(getAllCharactersRequest: GetAllCharactersRequest)
            : CharacterListResponse {
        return retrofitApi.getCharactersList(offset = getAllCharactersRequest.nextPage)
    }

    override suspend fun getCharacterDetail(getCharacterDetailRequest: GetCharacterDetailRequest)
            : CharacterDetailResponse {
        return retrofitApi.getCharacterDetail(getCharacterDetailRequest.id)
    }

    override suspend fun getCharacterComicsList(
        getCharacterComicsListRequest
        : GetCharacterComicsListRequest
